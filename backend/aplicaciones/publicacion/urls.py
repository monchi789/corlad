...
from .views import CategoriaViewSet, PublicacionViewSet, CategoriaAPIView, PublicacionAPIView, PublicacionesBolsaDeTrabajoViewSet
...
router.register(r'list-publicaciones-bolsa', PublicacionesBolsaDeTrabajoViewSet, basename='list-publicaciones-bolsa')
