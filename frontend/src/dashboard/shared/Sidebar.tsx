...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <div className={`fixed inset-y-0 left-0 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:relative lg:translate-x-0 transition duration-200 ease-in-out lg:w-1/5 w-64 h-svh bg-[#007336] rounded-2xl shadow-black shadow-lg m-3 p-3 mb-10 overflow-y-auto z-40`}>
