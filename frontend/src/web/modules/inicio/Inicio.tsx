...
const Header = lazy(() => import("../../shared/Header.tsx"));
const Card = lazy(() => import("../../shared/Cards"));
const Carrousel = lazy(() => import("../../shared/Carousel"));
const Footer = lazy(() => import("../../shared/Footer"));
const Contacto = lazy(() => import("../contactanos/contacto/Contacto"));
const Servicios = lazy(() => import("./components/Servicios"));
const PopUps = lazy(() => import("../../shared/PopUps"));
const Gallery = lazy(() => import("../../shared/Gallery"));
            ...
            <div className="flex flex-col xl:flex-row space-y-10 xl:space-y-0 xl:space-x-14 mb-12">
              {data.slice(0, 3).map((noticia, index) => (
                <Card
                  ...
                  cardText={limitarContenido(noticia.contenido, 15)}
