    ...
    <div className="w-full bg-[#363636] py-10 font-didact">
      <div className="container flex flex-col md:flex-row md:space-x-5 w-4/6 mx-auto ">
        <div className="flex flex-col md:w-2/5">
          ...
          <h3 className='font-extrabold text-2xl text-[#a67102] mt-6 mb-3 font-nunito'>HORARIO</h3>
        ...
        <div className='flex flex-col md:w-1/5'>
          <h3 className='font-extrabold text-2xl text-[#a67102] mt-20 mb-5 font-nunito'>MENU</h3>
          <div className='text-white text-xl'>
            <Link to={'/Inicio'}>
        ...
        <div className='md:w-1/5'>
          <h3 className='font-extrabold text-2xl text-[#a67102] mt-20 mb-10 font-nunito'>SIGUENOS</h3>
        ...
        <div className='md:w-1/5'>
          <h3 className='font-extrabold text-2xl text-[#a67102] mt-20 mb-5 font-nunito'>TELÉFONOS</h3>
