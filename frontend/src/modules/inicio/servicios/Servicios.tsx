...
export function Servicios() {
  return (
    <div className="flex flex-col md:flex-row space-y-24 md:space-x-6 md:space-y-0 justify-between text-center mb-24">
      <div className="flex flex-col rounded-3xl md:w-2/5 py-8 px-8 bg-[#F0F0F0] relative pt-16">
