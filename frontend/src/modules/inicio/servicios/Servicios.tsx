  ...
  return (
    <div className="flex flex-wrap xl:flex-nowrap md:flex-col xl:flex-row space-y-24 lg:space-y-24 xl:space-y-0 xl:space-x-6 justify-between text-center mb-24">
      <div className="flex flex-col w-full xl:w-1/3 py-8 lg:px-8 bg-[#F0F0F0] relative pt-16 rounded-3xl">
        ...
        <p className="text-[#363636] font-didact mt-auto mb-5">Consulta tu información y tu estado de colegiatura.</p>
      ...
      <div className="flex flex-col w-full xl:w-1/3 py-8 lg:px-8 bg-[#F0F0F0] relative pt-16 rounded-3xl">
        ...
        <h3 className="text-[#363636] font-extrabold text-xl my-5 font-nunito">CONVENIOS</h3>
        <p className="text-[#363636] font-didact mt-auto mb-5">Convenios entre intituciones regionales e nacionales.</p>
        <button className="mt-auto bg-[#a67102] text-white py-2 px-4 rounded-lg mx-auto font-mukta flex items-center justify-center space-x-2">
          <span>Más información</span>
          <FaArrowRightLong />
        </button>
      ...
      <div className="flex flex-col w-full xl:w-1/3 py-8 px-8 bg-[#F0F0F0] relative pt-16 rounded-3xl ">
        ...
        <h3 className="text-[#363636] font-extrabold text-xl my-5 font-nunito">COLEGIATURA</h3>
        <p className="text-[#363636] font-didact mt-auto mb-5">Información y requisitos necesarios para obtener  el registro único de colegiación.</p>
        <button className="mt-auto bg-[#a67102] text-white py-2 px-4 rounded-lg mx-auto font-mukta flex items-center justify-center space-x-2">
          <span>Más información</span>
          <FaArrowRightLong />
        </button>
      ...
      <div className="flex flex-col w-full xl:w-1/3 py-8 px-8 bg-[#F0F0F0] relative pt-16 rounded-3xl">
        ...
        <h3 className="text-[#363636] font-extrabold text-xl my-5 font-nunito">NOTICIAS</h3>
        <p className="text-[#363636] font-didact mt-auto mb-5">Mantente informado sobre nuestra institución y del sector profesional.</p>
        <Link to={"/noticias"}>
        <button className="mt-auto bg-[#a67102] text-white py-2 px-4 rounded-lg mx-auto font-mukta flex items-center justify-center space-x-2">
          <span>Más información</span>
          <FaArrowRightLong />
